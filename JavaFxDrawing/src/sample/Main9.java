                ...
                if (listEllipses.size() > 0) {
                    ...
                    if (ellipse != null) {
                        ...
                        for (Line line : listLines) {
                            if (Math.abs(line.getStartX() - ellipse.getCenterX()) < 45 && Math.abs(line.getStartY() - ellipse.getCenterY())<45) {
                                updateLineStartPoint(event.getSceneX(), event.getSceneY(), line);
                            } else if (Math.abs(line.getEndX() - ellipse.getCenterX()) < 45 && Math.abs(line.getEndY() - ellipse.getCenterY())<45) {
